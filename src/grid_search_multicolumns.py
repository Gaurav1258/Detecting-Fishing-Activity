...
from utilities import  get_scores, do_grid_search
from pipeline_noLatLon import *
...
N_cols = len(cols)  
sqr_N_cols = int(np.sqrt(N_cols))  
min_N_cols = int(sqr_N_cols/3) 
...
with open(pickle_name, 'wb') as pklf:
